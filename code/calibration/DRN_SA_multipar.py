...
model_ws = cwd
model_name = 'busca_base_infittito_apr24_drain_fondo_complesso'
...
drn = load_drn_file(os.path.join(model_ws, 'busca_base_infittito_apr24_drain_fondo_complesso_start.drn'))
...
#    'ka': [0.0001, 0.00001, 0.000001]
#}

# Define the hydraulic conductivities to be tested
k_dict = {
    'kt' : np.linspace(0.00001, 0.0001, num = 20), 
    'ka' : np.linspace(0.000001, 0.00001, num = 6)
}
