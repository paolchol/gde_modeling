...
drn_data = os.path.join(cwd,'busca_drain_specifiche_celle.csv') # DRN characteristics
model_ws = cwd
model_name = 'busca_base_infittito_apr24_drain_testa_scavo'
...
drn = load_drn_file(os.path.join(model_ws, 'busca_base_infittito_apr24_drain_testa_scavo_start.drn'))
...
k_dict = {
    'kt': [0.00001, 0.00002, 0.00003, 0.00004, 0.00005, 0.00006, 0.00007, 0.00008, 0.00009, 0.0001, 0.0005], 
    'ka': [0.00001]
}
...
df_results.to_excel(os.path.join(model_ws, 'drain_results_multipar_nuovo_target.xlsx'))
drain_outflow_save.to_csv(os.path.join(model_ws, 'drain_outflow_multipar_nuovo_target.csv'))
# %%
