...
cwd = os.getcwd()
sfr_data = os.path.join(cwd, 'busca_sfr_data.xlsx') # SFR characteristics
model_ws = cwd # Model working directory
model_name = 'busca_base_infittito_apr24_sfr_icalc1'
...
k_dict = {
    'kt': [5e-05, 5.1e-05, 5.2e-05, 5.3e-05, 5.4e-05], 
    'ka': [5e-06, 5.1e-06, 5.2e-06, 5.3e-06, 5.4e-06] 
}
