...
cwd = os.getcwd()
sfr_data = os.path.join(cwd, 'busca_sfr_data_icalc2.xlsx') # SFR characteristics
model_ws = cwd # Model working directory
model_name = 'busca_base_infittito_apr24_sfr_icalc2'
...
seg_a = [2,3,4,5,6,7,8] # number of segments of the asta
...
reach = 1      #if single reach: just an integer, if more than one, write a list
segment = 3     #one segment for each reach
