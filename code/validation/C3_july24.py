...
drn_data = os.path.join(cwd, 'input_data', 'Busca_DRN','busca_drain_specifiche_celle.csv') # DRN characteristics
...
drn = load_drn_file(os.path.join(cwd, 'input_data', 'Busca_DRN', 'busca_base_infittito_apr24_drain_fondo_complesso_start.drn'))
...
df_results.to_excel(os.path.join(cwd, 'output_data', 'validation', 'C3_results_july24.xlsx'))
drain_outflow_save.to_csv(os.path.join(cwd, 'output_data', 'validation', 'C3_outflow_july24.csv'))
